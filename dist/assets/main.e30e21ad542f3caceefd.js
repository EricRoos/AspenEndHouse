...
(function ($) {
  setTimeout(function () {
    ...
    $('#element').toggle(); // Location Address
    //-------------------------------------------------------------------------------
    ...
    $('.my-tooltip').tooltip();
    $('input, textarea').placeholder(); // Initialize Date Picker
    //-------------------------------------------------------------------------------
    ...
    $('.rate-box').on('mouseover', function () {
      $('.rate-box').removeClass('highlight', {
        duration: 500
      });
  ...
  function clearPlaceholder(event, value) {
    ...
    if (input.value == $input.attr('placeholder') && $input.hasClass(settings.customClass)) {
      if ($input.data('placeholder-password')) {
        $input = $input.hide().nextAll('input[type="password"]:first').show().attr('id', $input.removeAttr('id').data('placeholder-id')); // If `clearPlaceholder` was called from `$.valHooks.input.set`
  ...
  function setPlaceholder() {
    ...
    if (input.value === '') {
      if (input.type === 'password') {
        ...
        $input = $input.removeAttr('id').hide().prevAll('input[type="text"]:first').attr('id', id).show(); // Note: `$input[0] != input` now!
      }
...
/******/ 			// return url for filenames based on template
/******/ 			return "assets/" + "main" + "." + undefined + ".css";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => "0ce19c92e97ed31a6ff8"
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "aspenendhouse:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdateaspenendhouse"] = (chunkId, moreModules, runtime) => {
